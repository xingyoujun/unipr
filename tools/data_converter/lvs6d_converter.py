...
def create_lvs6d_infos(root_path, split_name):
    """
    ...
    for image_id in mmcv.track_iter_progress(range(len(left_dataset.imgs))):
    ...
    info_path = osp.join(root_path, f'lvs6d_infos_{split_name}.pkl')
