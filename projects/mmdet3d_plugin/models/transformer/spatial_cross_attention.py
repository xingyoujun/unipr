...
class SpatialCrossAttention(BaseModule):
    ...
    def forward(self,
        ...
        queries = torch.split(query, [self.tpv_v*self.tpv_u, self.tpv_d*self.tpv_u, self.tpv_d*self.tpv_v], dim=1)
        if residual is None:
